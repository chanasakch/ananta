					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
						...
						<td class="product-name" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
							...
							if (! $product_permalink) {
								...
								echo wp_kses_post(apply_filters('woocommerce_cart_item_name', sprintf('<a href="%s"><strong>%s</strong></a>', esc_url($product_permalink), $_product->get_name()), $cart_item, $cart_item_key));
							}
							...
							// Short Description (product description below title)
							$short_description = $_product->get_short_description();
							if ($short_description) {
								echo '<div class="woocommerce-product-details__short-description">' . wp_kses_post($short_description) . '</div>';
							}
